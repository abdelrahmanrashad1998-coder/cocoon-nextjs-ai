...
import { Calculator, Save, Download, Plus, Trash2, Eye } from "lucide-react"
...
import { QuoteExportModal } from "@/components/quote/quote-export-modal"
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={handleExportQuote} variant="outline">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Add and configure aluminum work items for your quote
                    </CardDescription>
                  </div>
                ...
                {quoteData.items.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Start by adding your first aluminum work item
                    </p>
                    <Button onClick={handleAddItem}>
                      <Plus className="mr-2 h-4 w-4" />
                      Add First Item
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="text-center p-4 bg-muted rounded-lg">
                      <div className="text-2xl font-bold text-primary">
                        {calculateTotals().totalArea.toFixed(2)} m²
                      </div>
          ...
          <TabsContent value="contact" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter customer details and project information
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="projectLocation"
                      value={quoteData.contactInfo.location}
