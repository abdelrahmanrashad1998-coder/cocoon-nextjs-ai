...
export function QuoteSettings({ settings, onUpdate }: QuoteSettingsProps) {
  return (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => onUpdate('projectDuration', parseInt(e.target.value) || 60)}
                placeholder="60"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => onUpdate('discountPercentage', parseFloat(e.target.value) || 0)}
                placeholder="0"
              />
            </div>
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="totals">Show Totals Only</SelectItem>
                  <SelectItem value="detailed">Show Detailed Pricing</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
            <div className="p-3 bg-muted rounded-lg">
              ...
              <div className="text-primary">{settings.expirationDays} days</div>
            </div>
            <div className="p-3 bg-muted rounded-lg">
              <div className="font-medium">Project Duration</div>
              <div className="text-primary">{settings.projectDuration} days</div>
            </div>
            <div className="p-3 bg-muted rounded-lg">
              <div className="font-medium">Discount</div>
              <div className="text-primary">{settings.discountPercentage}%</div>
            </div>
            <div className="p-3 bg-muted rounded-lg">
              <div className="font-medium">Pricing Display</div>
              <div className="text-primary capitalize">{settings.pricingType}</div>
            </div>
          </div>
        </CardContent>
      </Card>
